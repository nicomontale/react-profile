        ...
        if (this.state.activeTab === 0) {
            return (
                <div className="projects-grid"  >
                    <Card shadow={5} >
                        <CardTitle onClick={this.handleShowDialogNTT} className="mdl-card__title_ntt" style={{ color: 'fff', height: '176px' }}></CardTitle>
                    ...
                    <Card shadow={5} >
                        <CardTitle onClick={this.handleShowDialogTrip} className="mdl-card__title_triporate" style={{ color: '#fff', height: '176px', }}></CardTitle>
            ...
            return (
                <div className="projects-grid">
                    <Card shadow={5} style={{ minWidth: '450', margin: 'auto'}}>
                        <CardTitle onClick={this.handleShowDialogTesi} className="mdl-card__title_tesi"  style={{ color: 'black', height: '306px', backgroundImage: 'url() center / cover' }}></CardTitle>
